/* Home copy — the locked 12 sections (decisions.md D1). Every string here is
   verbatim from copy-workbench/src/pages/home-alt.astro, [placeholder] marks
   included: the captain reviews copy in the workbench, not here. Do not edit
   copy in this file; change the workbench and re-copy. */
...
/** Section 2 · Logo / social-proof strip */
...
export const problem = {
  ...
  lede: 'The deck got approved. The pilot launched. Eighteen months later, smart people are still doing the slow thing by hand because nobody built them a better way. The technology was never the issue — the overwhelm was.',
...
export const knifeHead = {
  ...
  lede: 'The workaround feels cheap because nobody sends an invoice for it. Here’s what it’s actually costing.',
...
export const solution = {
  h2: '0 → 1 → n.',
  lede: 'Prove it, ship it, multiply it. Discovery finds the three workflows where the money moves fastest. Production puts the first one live inside your systems. Multiply ships the next ones on the foundation already built — each faster and cheaper than the last.',
};
...
export const howItWorks = {
  ...
  lede: 'Most teams don’t need to understand AI. They need it to work. The whole experience:',
};

/** Section 8 · Competitor comparison */
export const comparisonHead = {
  h2: 'Your other options, honestly.',
  lede: 'None of these are wrong. They’re just slower, pricier, or riskier than they need to be for a problem this size.',
...
export const why = {
  ...
  line: 'We use AI, but we’re not emotionally attached to it. We’re attached to fixing the problem.',
  cta: 'Get in Touch →',
  href: '/get-in-touch/',
};

/** Section 11 · FAQ */
export const faqHead = { h2: 'Asked on almost every intro call.' };
export const homeFaq = [...faq, ...extraFaq];

/** Section 12 · Final CTA */
export const finalCta = {
  h2: 'The first conversation is free. The roadmap is yours either way.',
  lede: 'Thirty minutes with a founder. You describe the operation; we tell you honestly whether there’s a case.',
};
